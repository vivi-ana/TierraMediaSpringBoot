...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        UserCredentialEntity userCredentialEntity = null;
        String userName = "";
        String pass = "";
        try {
            userCredentialEntity = new ObjectMapper().readValue(request.getInputStream(), UserCredentialEntity.class);
            userName = userCredentialEntity.getUsername();
            pass = userCredentialEntity.getPassword();
